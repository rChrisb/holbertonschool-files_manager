...
const router = (app) => {
  ...
  route.get("/connect", (request, response) =>
    AuthController.getConnect(request, response)
  );
  route.get("/disconnect", (request, response) =>
    AuthController.getDisconnect(request, response)
  );
  route.get("/users/me", (request, response) =>
    UsersController.getMe(request, response)
  );
  route.post("/files", (request, response) =>
  ...
  route.put("/files/:id/publish", (request, response) =>
    FilesController.putPublish(request, response)
  );
  route.put("/files/:id/unpublish", (request, response) =>
    FilesController.putUnpublish(request, response)
  );
  route.get("/files/:id/data", (request, response) =>
